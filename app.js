...
const PRESETS = {
  intro: {
    label: "简要介绍一下自己",
    answer: `邓殷琪，生态伙伴总监/AI实践者。6年B2B大客户商业化经验，曾任深圳不停科技生态伙伴总监，主导国际KA全链路商业化及全球渠道体系搭建。

**核心数据：** 项目中标率100%，KA复购率超80%，采购周期平均压缩67%，渠道Pipeline贡献占比30%。

**行业覆盖：** 酒店、零售超市、航空等国际KA，最快2周完成CEO级建联。

**职业转向：** 2025年11月启动主动转型，系统深化AI技术认知。已完成清华大学数字经济研究生考试（2026-2028入学），深度使用Claude和GPT，实践Agent开发、个人数字分身、学习Web等多个AI应用项目。`
  },
  funfacts: {
    label: "关于我的 Fun Facts",
    answer: `• 从商业从业者转向技术探索者：在充分验证自己对AI的热情与天赋后，做了不那么"安全"的选择，主动进修清华数字经济研究生，实践多个AI项目
• 爱读毛泽东《论持久战》，习惯用战略框架思考商业问题，现在也用这套框架理解AI技术发展
...
**AI落地路径：** 具备将AI产品价值转化为客户业务语言的能力，能帮客户想清楚"怎么用、用在哪、怎么证明价值"

**AI技术实践：** 深度使用Claude、GPT等大模型，实践Agent开发、Vibe Coding等前沿技术，具备系统性思考AI应用的能力
